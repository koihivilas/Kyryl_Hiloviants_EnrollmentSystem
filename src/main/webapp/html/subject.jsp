...
<head>
    <meta charset="UTF-8">
    <title><c:out value="${s.name}"/> | EnrollmentSystem</title>
        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <h5 class="my-3"><c:out value="${s.name}" /></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0"><c:out value="${s.name}" /></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0"><c:out value="${s.description}" /></p>
                        </div>
                    </div>
                    <c:if test="${sessionScope.user.role.code == 'ADMIN'}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0"><c:out value="${s.closed ? 'Closed' : 'Opened'}" /></p>
                            </div>
                        </div>
                    </c:if>
                </div>
